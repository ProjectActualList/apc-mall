    ...
    addressSelect.prototype = {
        ...
        clickRegion: function () {
            ...
            _node.app_main.on('click', '.regions', function () {
                ...
                if (_this.params.index === 4) {
                  _this.useResone(_this.params.region_id, [])
                } else {
        ...
        accessApi: function (region_id) {
            var _this   = this;
            var options = {
                url    : _this.options.api.replace('@id', region_id),
                type   : 'GET',
        ...
        createStyles: function () {
          if ($('#addressSelectorStyle').length > 0) return
            var style    = document.createElement('style'),
                head     = document.head || document.getElementsByTagName('head')[0];
            style.type   = 'text/css';
            style.id     = 'addressSelectorStyle'
