  ...
  export default {
    ...
    mounted() {
      ...
      API_AfterSale.getAfterSaleData(this.order_sn, this.sku_id).then(response => {
        ...
        // this.returnMoneyForm.return_money = Foundation.formatPrice(refund_price * num)
        // this.returnGoodsForm.return_money = Foundation.formatPrice(refund_price * num)
        this.returnMoneyForm.return_money = refund_price
        this.returnGoodsForm.return_money = refund_price
    ...
    watch: {
      ...
      'returnGoodsForm.return_num': function (newVal) {
        ...
        this.returnGoodsForm.return_money = Foundation.formatPrice(newVal * refund_price)
      }
    },
    methods: {
      /** 申请售后类型发生变化 */
