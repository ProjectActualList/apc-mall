  ...
  <div id="app" class="container">
    <div v-if="error.statusCode === 404" class="error-404">
      ...
      <div class="error-right">
        ...
        <div>
          <el-button type="danger" size="small" @click="history.back()">返回上页</el-button>
          <el-button type="danger" size="small" @click="location.href = '/'">去首页</el-button>
        </div>
      </div>
    </div>
    ...
    <div v-else class="error-500">
      ...
      <div class="inner-btns">
        <el-button size="small" @click="history.back()">返回上页</el-button>
        <el-button size="small" @click="handleReload">刷新页面</el-button>
      </div>
    </div>
  </div>
